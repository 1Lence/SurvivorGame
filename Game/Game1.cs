...
public class Game1 : Game
{
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if (Keyboard.GetState().IsKeyDown(Keys.D) && !Keyboard.GetState().IsKeyDown(Keys.E)) PlayerController.Right();
        ...
        if (Keyboard.GetState().IsKeyDown(Keys.S) && !Keyboard.GetState().IsKeyDown(Keys.E)) PlayerController.Down();
        ...
        if (Keyboard.GetState().IsKeyDown(Keys.A) && !Keyboard.GetState().IsKeyDown(Keys.E)) PlayerController.Left();
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        _spriteBatch.Begin(transformMatrix: TranslationManager._translation);
